...
export function SoarOrbital() {
  ...
  return (
    <div style={{ position: 'relative', width: '100%', maxWidth: '550px', margin: '0 auto', padding: '16px', overflow: 'hidden' }}>
      <svg viewBox="-16 -16 332 262" width="100%" style={{ overflow: 'visible' }}>
        {/* Orbit ring */}
        <circle
